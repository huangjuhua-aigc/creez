...
/** 与 @mariozechner/pi-ai getModel(provider, id) 注册表一致；自定义模型请用手动输入（若 UI 支持）或 OpenRouter。 */
const PROVIDER_MODELS: Record<string, string[]> = {
  ...
  "minimax-cn": ["MiniMax-M2.7", "MiniMax-M2.7-highspeed"],
  "kimi-coding": ["k2p5", "kimi-k2-thinking"],
  zai: ["glm-5", "glm-5-turbo", "glm-4.7"],
