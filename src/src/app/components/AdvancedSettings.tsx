...
const PROVIDER_MODELS: Record<string, string[]> = {
  ...
  minimax: ["MiniMax-M2.7", "MiniMax-M2.5", "MiniMax-M2.1", "MiniMax-M2", "MiniMax-M2.5-highspeed"],
  "minimax-cn": ["MiniMax-M2.7", "MiniMax-M2.5", "MiniMax-M2.1", "MiniMax-M2", "MiniMax-M2.5-highspeed"],
